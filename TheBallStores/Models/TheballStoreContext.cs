...
namespace TheBallStores.Models
{
    public partial class TheballStoreContext : DbContext
    {
        ...
        protected override void OnModelCreating(ModelBuilder modelBuilder)
        {
            ...
            {
                entity.HasKey(e => e.MaCt).HasName("PK__ChiTietD__27258E7446AD14B2");
            ...
            {
                entity.HasKey(e => e.MaDonHang).HasName("PK__DonHangs__129584AD370F3EB8");
                ...
                entity.Property(e => e.SoDienThoaiNguoiNhan).HasMaxLength(15).IsUnicode(false);
                entity.Property(e => e.TenNguoiNhan).HasMaxLength(100);
                entity.Property(e => e.TongTien).HasColumnType("decimal(18, 0)");

                // SQLite string default
            ...
            {
                entity.HasKey(e => e.MaKh).HasName("PK__KhachHan__2725CF1E7C01B1ED");
                entity.Property(e => e.MaKh).HasColumnName("MaKH");
                entity.Property(e => e.DiaChi).HasMaxLength(200);
                entity.Property(e => e.DienThoai).HasMaxLength(15).IsUnicode(false);
                entity.Property(e => e.Email).HasMaxLength(100);
                entity.Property(e => e.HoTen).HasMaxLength(100);
                entity.Property(e => e.MatKhau).HasMaxLength(100);
                entity.Property(e => e.VaiTro).HasMaxLength(20).HasDefaultValueSql("'Customer'");
            });

            // CẤU HÌNH KichThuoc
            modelBuilder.Entity<KichThuoc>(entity =>
            {
                entity.HasKey(e => e.MaSize).HasName("PK__KichThuo__A787E7ED598484B8");
                entity.Property(e => e.TenSize).HasMaxLength(20);
            });

            // CẤU HÌNH LoaiSanPham
            ...
            // CẤU HÌNH SanPhamChiTiet
            modelBuilder.Entity<SanPhamChiTiet>(entity =>
            {
                entity.HasKey(e => e.MaChiTiet).HasName("PK__SanPhamC__CDF0A11446FCB7A6");
                entity.Property(e => e.MaSp).HasColumnName("MaSP");
